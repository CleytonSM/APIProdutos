...
import br.com.cleyton.apiProdutos.ApiProdutosTests.exception.EmptyRequestBodyException;
...
public class PatchValidator {
    ...
    public ProductModel getProductModel(Optional<ProductModel> optionalProductModel) {
